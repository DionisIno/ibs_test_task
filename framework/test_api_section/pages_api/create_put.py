...
class CreatePut(BasePage):
    url = GetUrl()

    @allure.description("Update user data using name and job. PUT method")
    def put_update_user(self, elem):
        """
    ...
    @allure.description("Update user data using job only. PUT method")
    def put_update_user_with_job_only(self, elem):
        """
    ...
    @allure.description("Update user data using name only. PUT method")
    def put_update_user_with_name_only(self, elem):
        """
    ...
    @allure.description("Update user data using job only. PUT method")
    def put_update_user_without_data(self, elem):
        """
